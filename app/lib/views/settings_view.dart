          ...
          ListView(
            ...
            children: [
              ...
              _buildSectionCard(
                ...
                children: [
                  const Text('Asztali indítási parancsikonok és parancssori (TUI / CLI) elérés:', style: TextStyle(color: PalaTheme.textMuted, fontSize: 12)),
                  const SizedBox(height: 10),
                  Wrap(
                    spacing: 8,
                    runSpacing: 8,
                    children: [
                      ElevatedButton.icon(
                        ...
                        label: const Text('Start Menü Parancsikon', style: TextStyle(fontSize: 12)),
                      ),
                      OutlinedButton.icon(
                        onPressed: () {
                        ...
                        label: const Text('CLI & TUI Parancsok', style: TextStyle(fontSize: 12)),
                      ),
                    ],
                  ),
                ],
